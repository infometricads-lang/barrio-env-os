...
export function WhatsAppButton({ 
  ...
  return (
    ...
    >
      ...
      {/* Tooltip on hover */}
      <span className="absolute right-16 top-1/2 -translate-y-1/2 bg-card text-foreground text-sm font-medium px-3 py-2 rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap pointer-events-none border border-border">
        ¿Necesitas ayuda?
      </span>
    </a>
  );
